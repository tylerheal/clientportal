                        ...
                        <tr>
                            ...
                            <td>
                                <div class="order-actions">
                                    <a class="button button--ghost" href="<?= e(url_for('admin/orders/' . (int) $order['id'])); ?>">View</a>
                                    <form action="<?= e(url_for('dashboard')); ?>" method="post" class="inline-form order-actions__form">
