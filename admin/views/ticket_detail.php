...
<section class="page-section">
    ...
    <header class="page-header">
        <div>
            <a class="button button--ghost" href="<?= e(url_for('admin/tickets')); ?>">← Back to tickets</a>
            <h2><?= e($selectedTicket['subject']); ?></h2>
            <p>Client: <?= e($selectedTicket['client_name']); ?> · Ticket #<?= (int) $selectedTicket['id']; ?></p>
        </div>
        <div class="page-actions">
            <form action="<?= e(url_for('dashboard')); ?>" method="post" onsubmit="return confirm('Delete this ticket?');">
    ...
    <div class="ticket-layout">
        ...
        <aside class="card ticket-sidebar">
            ...
            <ul>
                ...
                <li><span>Client</span><strong><?= e($selectedTicket['client_name']); ?></strong></li>
